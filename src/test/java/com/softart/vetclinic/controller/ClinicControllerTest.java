...
class ClinicControllerTest extends IntegrationTestBase {
    ...
    void create_success() throws Exception {
        var request = new CreateClinicRequest("New Clinic", "12345678",
                "new@clinic.test", "+381333333333", "Main St 1", "Nis", "Serbia",null,null, null, null, null, null,
    ...
    void update_success() throws Exception {
        var updateRequest = new UpdateClinicRequest("Clinic A Updated", null, null, null, null,null, null, null, null,null,
    ...
    void delete_success() throws Exception {
        ...
        var request = new CreateClinicRequest("Temp Clinic", null, null, null, null, null, null,null, null,null, null, null, null,
                null, SubscriptionPlan.BASIC, null, true, "{}");
