...
public interface AuditLogRepository extends JpaRepository<AuditLog, UUID> {
    ...
    Page<AuditLog> findByClinicIdAndCreatedAtBetweenOrderByCreatedAtDesc(
            UUID clinicId, OffsetDateTime from, OffsetDateTime to, Pageable pageable);

    Page<AuditLog> findByClinicIdAndEntityTypeAndEntityIdOrderByCreatedAtDesc(
            UUID clinicId, String entityType, UUID entityId, Pageable pageable);
}
